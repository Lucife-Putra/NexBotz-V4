 ...
 if (teks == 'edukasi') tags = {
  ...
  try {
      ...
      const sections = [
   {
	...
	rows: [
	    {title: `❏ ɪɴғᴏ ʙᴏᴛ`, rowId: ".botinfo", description: "✧ ᴍᴇɴᴀᴍᴘɪʟᴋᴀɴ ɪɴғᴏ ʙᴏᴛ sᴀᴀᴛ ɪɴɪ"},
	    {title: `❏ ᴏᴡɴᴇʀ`, rowId: ".owner", description: "✧ ᴍᴇɴᴀᴍᴘɪʟᴋᴀɴ ɴᴏᴍᴏʀ ᴏᴡɴᴇʀ"},
            {title: `❏ ʀᴇǫᴜᴇsᴛ ғɪᴛᴜʀ`, rowId: ".request", description: "✧ ʀᴇǫᴜᴇsᴛ ғɪᴛᴜʀ ᴋᴇ ʙᴏᴛ"},
            {title: `❏ ᴛᴇsᴛ sᴘᴇᴇᴅ`, rowId: ".testspeed", description: "✧ ɪɴsᴛᴀʟʟ ᴋᴇᴄᴇᴘᴀᴛᴀɴ sᴇʀᴠᴇʀ ʙᴏᴛ"},
	{title: `❏ sᴘᴇᴇᴅ`, rowId: ".speed", description: "✧ ᴋᴇᴄᴇᴘᴀᴛᴀɴ ʀᴇsᴘᴏɴ ʙᴏᴛ"},
	]
    },{
	title: `${htki} ⚠︎ 𝖢 𝖠 𝖳 𝖤 𝖦 𝖮 𝖱 𝖸 ︎⚠︎  ${htka}`,
	rows: [
	    {title: `• sᴇᴡᴀ ʙᴏᴛ︎ `, rowId: ".sewabot", description: "✧ ᴍᴇɴᴀᴍᴘɪʟᴋᴀɴ ʜᴀʀɢᴀ sᴇᴡᴀʙᴏᴛ ᴋᴇ ɢᴄ"},
	    {title: `• ᴜᴘɢʀᴀᴅᴇ ᴘʀᴇᴍɪᴜᴍ`, rowId: ".sewabot", description: "✧ ᴍᴇɴᴀᴍᴘɪʟᴋᴀɴ ʜᴀʀɢᴀ ᴜᴘ ᴘʀᴇᴍɪᴜᴍ ᴜsᴇʀ"},
	    {title: `• ɢᴇᴛ ʜᴀᴅɪᴀʜ`, rowId: ".daily", description: '✧ ᴄʟᴀɪᴍ ʏᴏᴜʀ ɢɪғᴛ'},
	    {title: `• ᴅᴏɴᴀᴛᴇ ғᴏʀ ʙᴏᴛ`, rowId: ".donasi", description: '✧ ᴅᴏɴᴀᴛᴇ ғᴏʀ ʙᴏᴛ ᴀɢᴀʀ ᴛᴇᴛᴀᴘ ᴏɴ 24/ᴊᴀᴍ'},
	{title: `• ʙᴇʀɪ ʙɪɴᴛᴀɴɢ/ʀᴀᴛᴇ`, rowId: ".rate", description: '✧ ʙᴇʀɪ ɴɪʟᴀɪ ᴋᴇᴘᴀᴅᴀ ʙᴏᴛ'},    
	{title: `• ᴍʏ ᴘʀᴏғɪʟᴇ`, rowId: ".profile", description: '✧ ᴍᴇɴᴀᴍᴘɪʟᴋᴀɴ ᴘʀᴏғɪʟᴇ ᴋᴀᴍᴜ'},
	]
	},{
